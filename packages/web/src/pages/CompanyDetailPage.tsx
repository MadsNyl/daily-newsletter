...
function sourceColor(source: string): string {
  ...
  if (source === "CNBC") return "text-[var(--color-source-cnbc)]";
  if (source === "Yahoo Finance") return "text-[var(--color-source-yahoo)]";
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-10 border-b border-border bg-surface/95 backdrop-blur-sm">
        <div className="mx-auto flex max-w-2xl items-center gap-3 px-4 py-3 lg:max-w-5xl lg:px-8 xl:max-w-6xl">
          <button
      ...
      <div className="mx-auto max-w-2xl lg:max-w-5xl lg:px-8 xl:max-w-6xl">
        {/* Desktop: two-column layout */}
        <div className="lg:grid lg:grid-cols-[1fr_360px] lg:gap-10 xl:grid-cols-[1fr_420px]">
          {/* Left column: Price, Chart, Key metrics */}
          <div>
            {/* Pris */}
            <div className="border-b border-border-light px-4 py-4 lg:px-0 lg:py-6">
              {loadingQuote ? (
                <div>
                ...
                <>
                  <div className="flex items-baseline gap-2">
                    <span className="text-3xl font-bold text-ink lg:text-4xl">
            ...
            {/* Nøkkeltall */}
            {(loadingQuote || quote) && (
            <div className="border-b border-border-light px-4 py-4 lg:border-b-0 lg:px-0 lg:py-6">
          ...
          {/* Right column: Analysts, Owners, Articles */}
          <div className="lg:border-l lg:border-border-light lg:pl-10">
            {/* Analytikere */}
            {(loadingQuote || quote) && (
            <div className="border-b border-border-light px-4 py-4 lg:px-0 lg:py-6 lg:first:pt-6">
